...
COMMON_SRC		=	validate_key.c close_fd.c error_mes.c is_quote.c is_line_empty.c \
					free_functions.c free_functions_2.c
...
BUILTIN_SRC		=	cd.c exit.c pwd.c echo.c env.c unset.c export.c \
					...
					export_print_sorted_env.c export_error.c split_key_value.c
