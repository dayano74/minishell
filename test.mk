...
#    Updated: 2025/04/24 14:31:51 by ttsubo           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = cd.c exit.c echo.c env.c unset.c tokenizer.c perser.c
...
test_%.out: tests/perser/test_%.c
	$(CC) $^ src/perser/*.c src/tokenizer/*.c $(L_FLG) $(I_FLG) -o $@
